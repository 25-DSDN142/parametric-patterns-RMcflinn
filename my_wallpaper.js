...
let Clouds = 3; 
let SpidermanShape = 1;
let SmallOrbs = 2;
let Flowers = 0;
let BrightenTheStar = 2


//Motif Parameters 
let WhiteEllipseWidth = 20; 
let WhiteEllipseHeight = 105;
let GoldFlowerWidth= 10;
...
function wallpaper_background() {
  ...
  if (BackgroundColour == 2) {
    background(20, 22, 140);
  }
  if (BackgroundColour == 3) {
    background(160, 30, 189);
  }
  if (BackgroundColour == 4) {
    background(189, 26, 72);
  }
}
...
function my_symbol() { 
  ...
  if (Flowers >= 2) {
    ...
    ellipse(90, 20, 20, 5);
    ellipse(90, 20, 5, 20);
    ellipse(160, 170, 5, 20);
    ellipse(160, 170, 20, 5);
  }
